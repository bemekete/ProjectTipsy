...
export default function Shopbasket() {
    ...
    const inputAll = (checked) => {
        ...
        if (checked) {
            // 모두 선택할 경우
            const temp = [];
            shopData.map((item) => temp.push(item.p_name));
            setCheckValid(temp);
            setSum(shopData);
        } else {
            // 모두 해제할 경우
                ...
                <div className="main_contents">
                        ...
                        <div className="order_tit">
                            ...
                            <ul>
                                <li className="Now_select">
                                    ...
                                    <img
                                        className="tri_arrow"
                                        src={require('../../assets/basket_img/right-arrow.png')}
                                        alt="화살표이미지"
                                    />
                                </li>
                                <li>
                    ...
                    <div className="price_sum">
                        <div className="price_sum_list">
                            ...
                            <span>
                                <img
                                    src={require('../../assets/basket_img/plus.jpg')}
                                    alt="더하기 그림"
                                    width="20px"
                                />
                            </span>
                                ...
                                <tbody className="option_select">
                                    <tr>
                                        <td>
                                            ...
                                            <a
                                                href=""
                                                className="select_scroll_img"
                                            ></a>
                                        </td>
                                        <td></td>
                                        <td>
                                            <div className="option_select_btn">
                                                <button data-count-value="1">
                                                    +
                                                </button>
                                                <button data-count-value="-1">
                                                    -
