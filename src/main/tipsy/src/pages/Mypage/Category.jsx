        ...
        <div className="category" id="category">
            <ul className="categoryList">
                <li className="nowpage">
                    <Link to="/mypage/shipment" onClick={e => { onClickCategory(e); }}>주문내역</Link>
                </li>
                <li>
                    <Link to="/mypage/postbox" onClick={e => { onClickCategory(e); }}>게시글</Link>
                </li>
                <li>
                    <Link to="/mypage/likecon" onClick={e => { onClickCategory(e); }}>관심 상품</Link>
                </li>
                <li>
                    <Link to="/mypage/currentcon" onClick={e => { onClickCategory(e); }}>최근 본 상품</Link>
                </li>
                <li>
                    <Link to="/mypage/alcstyle" onClick={e => { onClickCategory(e); }}>나의 음주 스타일</Link>
                </li>
            </ul>
