            ...
            <div id="simple_inquiry_container">
                ...
                <form action="../faq/faq.html" className="simple_inquirybox">
                    ...
                    <div className="agree_container">
                        <p>
                            개인정보 수집 및 이용동의<span>&#42;</span>
                        </p>
                        <div className="agree_text">
                            <p>
                                1. 수집 항목 이름, 휴대전화번호, 주소
                                <br />
                                2. 수집 및 이용목적 고객상담서비스 제공을 위한
                                원활한 의사소통의 경로 확보
                                <br />
                                3.보유 및 이용기간 수집일로부터
                                3년(전자상거래등에서의소비자보호에관한법률에
                                따라 3년간 보관)
                                <br />※ 위 항목 ’개인정보 수집 및 이용동의‘를
                                거부하실 수 있습니다 . 동의를 거부하실 경우,
                                온라인을 통한 고객문의 접수가 되지 않습니다.
                            </p>
                            <div className="agree_use">
                                <label for="agree_use">
                                    <span>개인정보 수집 및 이용동의 확인</span>
                                </label>
                                <input
                                    type="checkbox"
                                    name="agree_use"
